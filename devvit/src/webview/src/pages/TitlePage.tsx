  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-bg-primary">
      ...
      <div className="text-center mt-4">
        ...
        <a
          href="https://github.com/blake365/promisance-rogue"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 text-text-muted hover:text-accent text-xs mt-2 transition-colors"
        >
